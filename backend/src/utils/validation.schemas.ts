...
export const createTournamentSchema = z.object({
  ...
  tournamentFormat: z.enum(['PLACEMENT', 'PER_KILL']).optional().default('PLACEMENT'),
  perKillRate: z.number().min(0).optional().nullable(),
  booyahPrize: z.number().min(0).optional().nullable(),
