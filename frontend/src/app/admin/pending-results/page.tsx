        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto glass-card rounded-2xl p-6 z-10">
            ...
            <div className="mt-5 p-4 rounded-xl bg-white/[0.03] border border-white/5 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
              ...
              <div><p className="text-zinc-500">Platform (20%)</p><p className="text-fire-400 font-bold">{formatCurrency(Number(selected.tournament.platformCommission))}</p></div>
              <div><p className="text-zinc-500">Host (8%)</p><p className="text-green-400 font-bold">{formatCurrency(Number(selected.tournament.hostCommission))}</p></div>
